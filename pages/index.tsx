...
import "../styles/globals.css"; // Vercel'in stilleri tanıması için bu satır gerekli.
...
// --- DÜZELTİLMİŞ STARFIELD FONKSİYONU ---
function Starfield() {
  ...
  }, []); // <-- useEffect burada kapanıyor

  // Starfield'ın <canvas> elementini return etmesi gerekiyor:
  return <canvas ref={canvasRef} className="pointer-events-none absolute inset-0 -z-20 h-full w-full" />;
} // <-- Starfield burada kapanıyor. Artık diğerleri bunun içinde değil.
